...
import kotlinx.android.synthetic.main.hiburan.*
...
class Home3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingBar3.setOnClickListener {
            startActivity(Intent(this@Home3Activity, SettingActivity::class.java))
        }

        buttonOlahraga3.setOnClickListener {
            startActivity(Intent(this@Home3Activity, Home2Activity::class.java))
        }

        buttonTerkini3.setOnClickListener {
            startActivity(Intent(this@Home3Activity, HomeActivity::class.java))
        }

        homeBar3.setOnClickListener {
            startActivity(Intent(this@Home3Activity, HomeActivity::class.java))
        }
    }
    ...
    override fun onStart() {
        ...
        if(!isLoggedIn) {
            val intent = Intent(this@Home3Activity, MainActivity::class.java)

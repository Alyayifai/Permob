...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settingBar1.setOnClickListener {
            startActivity(Intent(this@HomeActivity, SettingActivity::class.java))
        }

        buttonOlahraga1.setOnClickListener {
            startActivity(Intent(this@HomeActivity, Home2Activity::class.java))
        }

        buttonHiburan1.setOnClickListener {
            startActivity(Intent(this@HomeActivity, Home3Activity::class.java))
        }

        homeBar1.setOnClickListener {
